 ...
 * @author euris
 */
public class ConsultaCLucro extends javax.swing.JDialog {
    ConectaBanco conexao = new ConectaBanco();
    
    String SQL_consultaGeneria = "SELECT CD_CLUCRO, DS_CLUCRO FROM CENTROLUCRO";
    ...
    /**
     * Creates new form ConsultaCLucro
     */
    public ConsultaCLucro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        conexao.conecta();
        initComponents();
    ...
    public void preencherTabela(String SQL){
        ...
        try {
            conexao.rs.first();
            do{
                dados.add(new Object[]{conexao.rs.getString("CD_CLUCRO"),
                                       conexao.rs.getString("DS_CLUCRO")});
            }while(conexao.rs.next());
            
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Erro ao preencher o ArrayList da consulta do Centro de Lucro. \nErro: "+ ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Centros de Lucros");
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        String SQL_consulta = "SELECT CD_CLUCRO, DS_CLUCRO FROM CENTROLUCRO WHERE DS_CLUCRO LIKE '%"+jTextFieldConsulta.getText()+"%';";
