 ...
 * @author euris
 */
public class ConsultaRecCLucro extends javax.swing.JDialog {
     ...
     */
    public ConsultaRecCLucro(java.awt.Frame parent, boolean modal, String consulta) {
        super(parent, modal);
    ...
    ConsultaRecCLucro(JFrame jFrame, boolean b) {
    ...
    public void preencherTabela(String SQL){
        ...
        try {
            conexao.rs.first();
            do{ codigoCLucro = conexao.rs.getInt("CD_RECCLUCRO");
                dados.add(new Object[]{conexao.rs.getString("CD_RECCLUCRO"),
                                       conexao.rs.getString("DS_RECCLUCRO")});
            }while(conexao.rs.next());
            
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Erro ao preencher o ArrayList da consulta das Receitas por Centro de Lucro. \nErro: "+ ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Receita por Centro de Lucro");
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        String SQL_consulta = "SELECT CD_RECCLUCRO, DS_RECCLUCRO FROM RECEITACLUCRO WHERE DS_RECCLUCRO LIKE '%"+jTextFieldConsulta.getText()+"%' AND CD_RECCLUCRO = "+codigoCLucro+";";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaRecCLucro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaRecCLucro dialog = new ConsultaRecCLucro(new javax.swing.JFrame(), true);
